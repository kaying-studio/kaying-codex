...
自然语言描述需求，智能体自动规划并执行游戏开发流程。

![AI 对话工作台](zh-CN/01-ai-workspace.png)
...
3101 项语义标注、分类筛选与一键确认，素材真正绑定而非仅声明。

![语义素材库](zh-CN/02-asset-library.png)
...
本地与远端项目统一管理，支持从 TapTap Maker 恢复、一键加载到 Agent。

![游戏列表](zh-CN/03-game-list.png)
...
本地预览与官方 Runtime 联动，校验发布就绪状态并提交构建。

![TapTap 运行](zh-CN/04-taptap-runtime.png)
...
切换 Agent 引擎、配置 API Key，一键管理多个模型连接。

![大模型设置](zh-CN/05-llm-settings.png)
