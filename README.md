...
1. **先把事情做出来** — 入口从目标和材料开始，不是再学一个复杂工具
2. **让照片也能继续工作** — 通知、作业、表格、客户资料都可以成为下一份材料的起点
3. **能本地做的就本地做** — Markdown 转 Office 使用本地引擎，不消耗 token，离线也能完成
4. **把边界说清楚** — AI 创作需要模型能力，本地转换不需要 token
